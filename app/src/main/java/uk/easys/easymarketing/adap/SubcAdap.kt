...
class SubcAdap(var list: List<API.Product>) :
    RecyclerView.Adapter<SubcAdap.MyViewHolder>() {
    class MyViewHolder(val v: ConstraintLayout) : RecyclerView.ViewHolder(v)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var v = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_subc, parent, false) as ConstraintLayout
        val cl = v[0] as ConstraintLayout
        val ll = cl[0] as LinearLayout
    ...
    override fun onBindViewHolder(h: MyViewHolder, i: Int) {
        ...
        bookCL.setOnClickListener {
            ...
            Fun.transPop(book, bookCL, list[h.layoutPosition].book == 1.toByte())
        }
